...
import jotalac.market_viewer.market_viewer_api.dto.device.DeviceDto;
...
public interface DeviceRepository extends JpaRepository<Device, Integer> {
    ...
    @Query(" SELECT new jotalac.market_viewer.market_viewer_api.dto.device.DeviceDto(d.id, d.name, COUNT(s)) " +
            "FROM Device d " +
