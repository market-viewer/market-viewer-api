...
import jotalac.market_viewer.market_viewer_api.dto.api_response.crypto_api.CryptoGraphResponse;
...
import jotalac.market_viewer.market_viewer_api.exception.api_provider.AssetNameNotValid;
...
public class CoinGeckoCryptoProvider implements CryptoDataProvider {
    ...
    public void validateApiKey(String apiKey) {
        restClient.get()
                ...
                .header("x-cg-demo-api-key", apiKey)
                .retrieve()
                .onStatus(HttpStatusCode::isError, (_, _) -> {throw new ApiResponseError("CoinGecko API key is invalid");})
                .toBodilessEntity();
    }
